...
typedef class Selforganised : public Transport
{
public:
    Selforganised () { }
    ~Selforganised ()
...
typedef class Flight : public Publictransport
{
    bool transfer;
public:
    Flight () { }
...
typedef class Train : public Publictransport
{
public:
    Train () { }
